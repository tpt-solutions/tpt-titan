...
import { HttpError, SvelteKitError, Redirect, ActionFailure, ValidationError } from "@sveltejs/kit/internal";
...
import { r as readable, w as writable, c as create_ssr_component, i as setContext, j as afterUpdate, v as validate_component, m as missing_component, k as onMount, l as getContext, s as subscribe, b as escape } from "./calendar.js";
...
async function render_endpoint(event, event_state, mod, state) {
  ...
  if (state.prerendering && !state.prerendering.inside_reroute && !prerender2) {
    if (state.depth > 0) {
  ...
  try {
    ...
    if (state.prerendering && (!state.prerendering.inside_reroute || prerender2)) {
      ...
      if (state.prerendering.inside_reroute && prerender2) {
        cloned.headers.set(
          "x-sveltekit-routeid",
          encodeURI(
            /** @type {string} */
...
async function handle_remote_form_post_internal(event, state, manifest, id) {
  ...
  if (action_id) {
    form2 = with_request_store({ event, state }, () => form2.for(JSON.parse(action_id)));
  }
  try {
    const fn = (
...
const MAX_DEPTH = 10;
async function render_page(event, event_state, page2, options2, manifest, state, nodes, resolve_opts) {
...
const Root = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.form === void 0 && $$bindings.form && form2 !== void 0) $$bindings.form(form2);
...
const options = {
  ...
  templates: {
    app: ({ head, body: body2, assets: assets2, nonce, env }) => '<!doctype html>\r\n<html lang="en">\r\n	<head>\r\n		<meta charset="utf-8" />\r\n		<meta name="viewport" content="width=device-width, initial-scale=1" />\r\n\r\n		<!-- Favicon and Icons -->\r\n		<link rel="icon" type="image/x-icon" href="/favicon.ico" />\r\n		<link rel="manifest" href="/site.webmanifest" />\r\n\r\n		<!-- Theme and App Meta -->\r\n		<meta name="theme-color" content="#3b82f6" />\r\n		<meta name="description" content="Advanced business productivity suite with MS Access-style database features" />\r\n		<meta name="application-name" content="TPT Titan" />\r\n\r\n		<!-- Open Graph / Facebook -->\r\n		<meta property="og:type" content="website" />\r\n		<meta property="og:title" content="TPT Titan" />\r\n		<meta property="og:description" content="Advanced business productivity suite with MS Access-style database features" />\r\n\r\n		<!-- Twitter -->\r\n		<meta property="twitter:card" content="summary" />\r\n		<meta property="twitter:title" content="TPT Titan" />\r\n		<meta property="twitter:description" content="Advanced business productivity suite with MS Access-style database features" />\r\n\r\n		' + head + '\r\n	</head>\r\n	<body data-sveltekit-preload-data="hover">\r\n		<div style="display: contents">' + body2 + "</div>\r\n	</body>\r\n</html>\r\n",
...
function prerender(validate_or_fn, fn_or_options, maybe_options) {
  ...
  const wrapper = (arg) => {
    const promise = (async () => {
      ...
      if (!state.prerendering && !BROWSER && !event.isRemoteRequest) {
        try {
          return await get_response(__, arg, state, async () => {
            const key2 = stringify_remote_arg(arg, state.transport);
      ...
      if (state.prerendering) {
        const body2 = { type: "result", result: stringify(result, state.transport) };
  ...
  const __ = {
    ...
    run: (args) => {
      ...
      return run_remote_function(
        ...
        false,
        args,
        (array2) => Promise.all(array2.map(validate)),
        fn
      );
    }
  };
